...
"""
 Function to draw bitmap from lidar input. Meant to work with CP210x LiDAR. 
 Two functions are included. _liadr_to_bitmap is by default in "FILL" mode 
 and produces a map in 1 channel, grayscale. lidar_to_bitmap is in "POLYGON"
 mode by default and has the ability to produce RGB and RGBA maps.  
 Courtesy of Aly Ashour.
"""
